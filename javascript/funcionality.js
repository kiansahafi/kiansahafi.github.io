...
(function () {
  document
    .querySelector(".skills-prog li")
    .querySelector(".skills-bar")
    .each(function (i) {
      document
        .querySelector(this)
        .querySelector(".bar")
        ...
        .animate(
          {
            width:
              document.querySelector(this).parents().attr("data-percent") + "%",
          },
          1000,
          "linear",
          function () {
  ...
  document
    .querySelector(".skills-soft li")
    .querySelector("svg")
    .each(function (i) {
      var c, cbar, circle, percent, r;
      circle = document.querySelector(this).children(".cbar");
      r = circle.attr("r");
      c = Math.PI * (r * 2);
      percent = document.querySelector(this).parent().data("percent");
      cbar = ((100 - percent) / 100) * c;
      circle.css({
        "stroke-dashoffset": c,
        "stroke-dasharray": c,
      ...
      document
        ...
        .animate(
          ...
          },
          {
            duration: 1000,
            step: function (now) {
              return document.querySelector(this).text(Math.ceil(now) + "%");
            },
          }
        );
    });
